            ...
            <header className={`main-header header-style-two ${isSearch ? "moblie-search-active" : ""}`}>
                ...
                <div className="inner-container">
                    ...
                    <ul className="list-style-one light">
                        ...
                        <li><i className="fa fa-phone"></i> <Link href="tel:92880087890">+92 (8800) 87890</Link></li>
                    </ul>
                    </div>
                    <div className="top-right">
                    <ul className="feature-ilst">
                        <li><Link href="#">Help</Link></li>
                        <li><Link href="#">Track Now</Link></li>
                ...
                <div className="main-box">
                    ...
                    <div className="logo"><Link href="/"><img src="images/logo.png" alt="Logo" title="Lozics"/></Link></div>
                    </div>
                    ...
                    <div className="btn-box">
                        <Link href="page-contact" className="theme-btn btn-style-one orange-bg"><span className="btn-title">Get A Quote</span></Link>
                    </div>
